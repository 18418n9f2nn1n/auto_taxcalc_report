...
print("----------------------------------------------------------------------")
print("Begin execution of auto_calc.py")
print("----------------------------------------------------------------------")
print(" ")
policy_cl = Policy()
behavior_cl = Behavior()
...
print(" ")
print("----------------------------------------------------------------------")
print("Begin calculator generation")
print("----------------------------------------------------------------------")
dict_calculator(ref_dict, start_year, beh_dict, records_url)
print("----------------------------------------------------------------------")
print("Calculator generation complete")
print("----------------------------------------------------------------------")
print(" ")
print("----------------------------------------------------------------------")
print("Ten year cost estimates (static)")
print("----------------------------------------------------------------------")
dict_ten_year_cost(calc_dict, calc_cl)
print("----------------------------------------------------------------------")
print("Ten year cost estimates (static) complete")
print("----------------------------------------------------------------------")
print(" ")
print("----------------------------------------------------------------------")
print("Perform ten year cost estimates (with behavioral response)")
print("----------------------------------------------------------------------")
dict_ten_year_cost_PE(calc_cl, tyc_beh, calc_dict)
print("----------------------------------------------------------------------")
print("Ten year cost estimates (with behavioral response) complete")
print("----------------------------------------------------------------------")
print(" ")
print("----------------------------------------------------------------------")
print("Execution of auto_calc.py complete")
print("----------------------------------------------------------------------")
